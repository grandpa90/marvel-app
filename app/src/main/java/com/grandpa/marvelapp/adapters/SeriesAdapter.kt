...
class SeriesAdapter : RecyclerView.Adapter<SeriesAdapter.MyViewHolder>() {
    var seriesDataList = mutableListOf<SeriesDto>()

    class MyViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        private val tvName: TextView = view.findViewById(R.id.tvSeriesName)
        private val tvDescription: TextView = view.findViewById(R.id.tvSeriesDescription)
        private val imageView: ImageView = view.findViewById(R.id.seriesThumbImageView)

        fun bind(data: SeriesDto) {
...
//            Picasso.with(context).load(url).into(imageView)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        return SeriesAdapter.MyViewHolder(
            LayoutInflater.from(parent.context).inflate(R.layout.series_item_row, parent, false)
        )
    }

    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        holder.bind(seriesDataList[position])
    }
